...
function Pro5() {
  return (
    <div className="bg-[var(--secondary-text-color)] text-[var(--primary-text-color)] flex flex-col rounded-[20px] items-start h-[300px] w-[300px] p-[26px]">
      ...
      <div className="flex flex-row items-start p-[10px] justify-end flex-grow relative">
        ...
        <div className="flex flex-row mt-auto">
          <button className="px-[10px] py-[10px] mx-[5px]  rounded-full cursor-pointer hover:bg-[var(--hover-color)] border-none">
            <a
              href="https://github.com/m091u/GreenMind---ecommerce"
              target="_blank"
            >
              <FontAwesomeIcon
                icon={faGithub}
          ...
          <button className="px-[10px] py-[10px] mx-[5px]  rounded-full cursor-pointer hover:bg-[var(--hover-color)] border-none">
            <a
              href="https://greenmind-shop.netlify.app/"
              target="_blank"
