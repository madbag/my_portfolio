...
describe('ProjectCard Component', () => {
    ...
    it("always renders a Github link with the given href", () => {
        render(
            <ProjectCard
                icon="icon.svg"
                alt="My Project"
    ...
    it("renders a Website link when website is provided", () => {
        render(
            <ProjectCard
                icon="icon.svg"
                alt="My Project"
    ...
    it("does not render a Website link when website is not provided", () => {
        render(
            <ProjectCard
                icon="icon.svg"
                alt="My Project"
